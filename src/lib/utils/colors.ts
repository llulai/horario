const colorCycle = [
  'bg-[#FFE0E0] text-[#D43C3C] border-[#D43C3C]',
  'bg-[#ECE0FF] text-[#4C1D95] border-[#4C1D95]',
  'bg-[#E0E9FF] text-[#1C4ED8] border-[#1C4ED8]',
  'bg-[#FFEEE0] text-[#B4540A] border-[#B4540A]',
  'bg-[#FFE0EA] text-[#881337] border-[#881337]',
  'bg-[#E0F8FF] text-[#1E7B94] border-[#1E7B94]',
  'bg-[#E0FFEB] text-[#17803D] border-[#17803D]',
  'bg-[#FFE0ED] text-[#BE195D] border-[#BE195D]',
  'bg-[#FFF4CF] text-[#8C6E0B] border-[#8C6E0B]',
  'bg-[#E0F7FF] text-[#164E63] border-[#164E63]',
  'bg-[#FFEEE0] text-[#A84F09] border-[#A84F09]',
